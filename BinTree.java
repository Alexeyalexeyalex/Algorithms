...
public class BinTree<T extends Comparable<T>> {
    ...
    public boolean add(T value) {
        // Проверка на пустоту корнегого элемента
        if (root == null) {
    ...
    // Проверка на содержание элемента в дереве
    ...
    // Необходимая замена цветов после изменения дерева
